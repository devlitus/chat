...
import { $messages, $isStreaming, $streamingContent, $botError, $initialized } from '../../stores/chat-store';
      ...
      <div className="msg-content">
        ...
        <div className="bubble bot-bubble">
          <div role="status" style={{ display: 'flex', alignItems: 'center', gap: '8px', color: '#94a3b8', fontSize: '14px', fontStyle: 'italic', minWidth: '110px', minHeight: '24px' }}>
            <svg aria-hidden="true" style={{ height: '20px', width: '20px', color: '#06b6d4', animation: 'local-spin 1s linear infinite flex-shrink-0' }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    <div className="message-bot">
      ...
      <div className="msg-content">
        ...
        <div className="bubble bot-bubble error-bubble">
          <p><span className="material-symbols-outlined" style={{ fontSize: '18px', verticalAlign: 'middle', marginRight: '4px' }}>error</span>{error}</p>
        </div>
      </div>
    </div>
  );
