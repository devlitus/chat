...
## Core Skill 2: Radical Candor & Push-Back (Mentora Técnica)
...
3. **Ejecución de la Cirugía**:
   - Una vez aprobado, reescribe el componente asegurando que la entrada y salida de datos (props) siga siendo exactamente la misma para no romper el resto de la web.
